...
{
    public class DeactivateHandler : ResponseHandler, IRequestHandler<DeactivateCommand, Response<string>>
    {
        ...
        public async Task<Response<string>> Handle(DeactivateCommand request, CancellationToken cancellationToken)
        {
            ...
            return Success<string>(venue.Id.ToString(), "The Venue Deactivated Successfully");
        }
    }
}
