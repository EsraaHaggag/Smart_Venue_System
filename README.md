...
VenueCore is a robust and scalable backend application designed to manage venues, users, and booking workflows with a focus on clean architecture, security, and real-time performance.

The system follows industry best practices, applying Clean Architecture principles to ensure separation of concerns and maintainability. It leverages the CQRS pattern using MediatR to decouple business logic and improve code organization.
